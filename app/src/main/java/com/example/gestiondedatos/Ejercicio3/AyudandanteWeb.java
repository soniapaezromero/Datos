...
public class AyudandanteWeb  extends SQLiteOpenHelper {
    public static  final String NOMBRE_BASE= "webs_db";
    public static  final String NOMBRE_TABLA ="webs";
    private static final int VERSION_BASE_DE_DATOS = 1;

    public AyudandanteWeb(Context context) {
     ...
     */
    @Override// Creamos la base de datos con su Tabla
